...
export default function GameScreen({
  ...
  useEffect(() => {
    const opp = players[topPlayerIndex];
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.contentBody}>
              <View style={styles.boardWrapper}>
                {/* Top Player Score (Pemain 2) */}
                <View style={styles.topScoreContainer}>
                  <Score
                    playerName={players[topPlayerIndex].name}
                    score={players[topPlayerIndex].score || 0}
                    avatarSource={getAvatarSource(players[topPlayerIndex].avatarId)}
                    isTopPlayer={true}
                    soalTerjawabCount={players[topPlayerIndex].soalTerjawabCount || 0}
                    status={players[topPlayerIndex].status}
                  />
                </View>

                {/* Top Player Dice = Pemain 2 */}
                <View style={styles.topDiceContainer}>
                  <Image source={getDiceImage(playerLastRolls[topPlayerIndex])} style={styles.diceImage} resizeMode="contain" />
                </View>
                ...
                <View style={styles.bottomDiceContainer}>
                  <Image source={getDiceImage(playerLastRolls[bottomPlayerIndex])} style={styles.diceImage} resizeMode="contain" />
                </View>

                {/* Bottom Player Score (Pemain 1) */}
                <View style={styles.bottomScoreContainer}>
                  <Score
                    playerName={players[bottomPlayerIndex].name}
                    score={players[bottomPlayerIndex].score || 0}
                    avatarSource={getAvatarSource(players[bottomPlayerIndex].avatarId)}
                    isTopPlayer={false}
                    soalTerjawabCount={players[bottomPlayerIndex].soalTerjawabCount || 0}
                    status={players[bottomPlayerIndex].status}
                  />
                </View>
              </View>
            </View>
      ...
      <GamePopups
        ...
        endReason={endReason}
        players={players}
        localPlayerIndex={bottomPlayerIndex}
        onBack={onBack}
      ...
      {startCountdown === null && !gameFinished && (
        <View style={{
          ...
          backgroundColor: currentPlayerIndex === bottomPlayerIndex ? '#00BFFF' : '#FF4500',
          paddingVertical: 8,
          alignItems: 'center',
          ...
          <Text style={{ 
            ...
            {`Giliran ${players[currentPlayerIndex]?.name || 'Pemain'}`}
          </Text>
        </View>
      )}
