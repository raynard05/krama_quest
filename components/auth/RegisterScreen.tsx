      ...
      >
        <View style={{ flex: 1, paddingTop: insets.top, paddingBottom: insets.bottom }}>
          ...
          <View style={styles.card}>
            ...
            {/* Heading */}
            <Text style={styles.heading}>Dhaftar Akun</Text>
            <Text style={styles.subheading}>Jangkepana dhata ing ngisor iki.</Text>

            {/* Error */}
            {error ? <Text style={styles.errorText}>{error}</Text> : null}

            {/* Field: Jeneng Jangkep */}
            <Text style={styles.label}>Jeneng Jangkep</Text>
            <View style={[styles.inputWrap, focusedField === 'fullName' && styles.inputWrapFocused]}>
              <TextInput
                style={styles.input}
                placeholder="Ketik jeneng jangkep…"
